      ...
      <div className="max-w-4xl mx-auto">
        ...
        {cart.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-300">Good food is always cooking! Go ahead and order something delicious.</p>
          </div>
        ) : (
            ...
            <div className="md:col-span-2 space-y-4">
              {cart.map((item) => (
                ...
                >
                  ...
                  <span className="text-yellow-700 dark:text-yellow-400 font-bold">{item.price}</span>
                </div>
              ))}
            </div>
